...
function myfunc() {
  ...
  if ((topLeft == 'x' || topLeft == 'X') && (topMid == 'x' || topMid == 'X') && (topRight == 'x' || topRight == 'X')) {
  ...
  } else if ((topLeft == 'x' || topLeft == 'X') && (midLeft == 'x' || midLeft == 'X') && (btmLeft == 'x' || btmLeft == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    ...
    document.getElementById("bt3").disabled = true;
    window.alert('Player X won');
  } else if ((btmLeft == 'x' || btmLeft == 'X') && (btmMid == 'x' || btmMid == 'X') && (btmRight == 'x' || btmRight == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    ...
    document.getElementById("m3").disabled = true;
    window.alert('Player X won');
  } else if ((topRight == 'x' || topRight == 'X') && (midRight == 'x' || midRight == 'X') && (btmRight == 'x' || btmRight == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    document.getElementById("t1").disabled = true;
    document.getElementById("t2").disabled = true;
    document.getElementById("m1").disabled = true;
    ...
    document.getElementById("bt2").disabled = true;
    window.alert('Player X won');
  } else if ((topLeft == 'x' || topLeft == 'X') && (midMid == 'x' || midMid == 'X') && (btmRight == 'x' || btmRight == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    document.getElementById("t2").disabled = true;
    document.getElementById("t3").disabled = true;
    document.getElementById("m1").disabled = true;
    ...
    document.getElementById("bt2").disabled = true;
    window.alert('Player X won');
  } else if ((topRight == 'x' || topRight == 'X') && (midMid == 'x' || midMid == 'X') && (btmLeft == 'x' || btmLeft == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    document.getElementById("t1").disabled = true;
    document.getElementById("t2").disabled = true;
    document.getElementById("m1").disabled = true;
    ...
    document.getElementById("bt3").disabled = true;
    window.alert('Player X won');
  } else if ((topMid == 'x' || topMid == 'X') && (midMid == 'x' || midMid == 'X') && (btmMid == 'x' || btmMid == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    document.getElementById("t1").disabled = true;
    document.getElementById("t3").disabled = true;
    document.getElementById("m1").disabled = true;
    ...
    document.getElementById("bt3").disabled = true;
    window.alert('Player X won');
  } else if ((midLeft == 'x' || midLeft == 'X') && (midMid == 'x' || midMid == 'X') && (midRight == 'x' || midRight == 'X')) {
    document.getElementById('print').innerHTML = "Player X won";
    document.getElementById("t1").disabled = true;
    document.getElementById("t2").disabled = true;
    document.getElementById("t3").disabled = true;
  ...
  // not and after that disabled all the other fields
  else if ((topLeft == '0' || topLeft == '0') && (topMid == '0' || topMid == '0') && (topRight == '0' || topRight == '0')) {
    ...
    } else if ((topLeft == '0' || topLeft == '0') && (midLeft == '0' || midLeft == '0') && (btmLeft == '0' || btmLeft == '0')) {
      document.getElementById('print').innerHTML = "Player 0 won";
      document.getElementById("t2").disabled = true;
      document.getElementById("t3").disabled = true;
      document.getElementById("m2").disabled = true;
      ...
      document.getElementById("bt3").disabled = true;
      window.alert('Player 0 won');
    } else if ((btmLeft == '0' || btmLeft == '0') && (btmMid == '0' || btmMid == '0') && (btmRight == '0' || btmRight == '0')) {
      document.getElementById('print').innerHTML = "Player 0 won";
      document.getElementById("t1").disabled = true;
      document.getElementById("t2").disabled = true;
      document.getElementById("t3").disabled = true;
      ...
      document.getElementById("m3").disabled = true;
      window.alert('Player 0 won');
    } else if ((topRight == '0' || topRight == '0') && (midRight == '0' || midRight == '0') && (btmRight == '0' || btmRight == '0')) {
      document.getElementById('print').innerHTML = "Player 0 won";
      document.getElementById("t1").disabled = true;
      document.getElementById("t2").disabled = true;
      document.getElementById("m1").disabled = true;
      ...
      document.getElementById("bt2").disabled = true;
      window.alert('Player 0 won');
    } else if ((topRight == '0' || topRight == '0') && (midMid == '0' || midMid == '0') && (btmRight == '0' || btmRight == '0')) {
      document.getElementById('print').innerHTML = "Player 0 won";
      document.getElementById("t2").disabled = true;
      document.getElementById("t3").disabled = true;
      document.getElementById("m1").disabled = true;
      ...
      document.getElementById("bt3").disabled = true;
      window.alert('Player 0 won');
    } else if ((topMid == '0' || topMid == '0') && (midMid == '0' || midMid == '0') && (btmMid == '0' || btmMid == '0')) {
      document.getElementById('print').innerHTML = "Player 0 won";
      document.getElementById("t1").disabled = true;
      document.getElementById("t3").disabled = true;
      document.getElementById("m1").disabled = true;
      ...
      document.getElementById("bt3").disabled = true;
      window.alert('Player 0 won');
    } else if ((midLeft == '0' || midLeft == '0') && (midMid == '0' || midMid == '0') && (midRight == '0' || midRight == '0')) {
      document.getElementById('print').innerHTML = "Player 0 won";
      document.getElementById("t1").disabled = true;
      document.getElementById("t2").disabled = true;
      document.getElementById("t3").disabled = true;
